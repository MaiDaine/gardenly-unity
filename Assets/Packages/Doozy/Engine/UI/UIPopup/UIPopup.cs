...
namespace Doozy.Engine.UI
{
    ...
    public class UIPopup : UIComponentBase<UIPopup>
    {
...
#if dUI_TextMeshPro
            GameObject message = CreateTextMeshProLabel("UIPopupMessage", "message", container);
#else
            GameObject message = CreateTextLabel("UIPopupMessage", "message", container);
#endif
        ...
        /// <summary> Hides this UIPopup after the set delay </summary>
        ...
        /// <summary> Hides this UIPopup </summary>
        ...
        /// <summary> Shows this UIPopup </summary>
        /// <param name="instantAction"> Should the animation happen instantly? (zero seconds) </param>
        ...
        /// <summary> Sends an UIPopupMessage notifying the system that an UIPopupBehavior has been triggered </summary>
        ...
        /// <summary> Sets the PopupName property. Used by the UIPopupManager to identify this UIPopup </summary>
        ...
        private IEnumerator ShowEnumerator(bool instantAction)
        {
            ...
            if (!ShowBehavior.Animation.Move.Enabled) Container.ResetPosition();
            ...
            if (!ShowBehavior.Animation.Rotate.Enabled) Container.ResetRotation();
            ...
            if (!ShowBehavior.Animation.Scale.Enabled) Container.ResetScale();
            ...
            if (!ShowBehavior.Animation.Fade.Enabled) Container.ResetAlpha();
...
//                yield return new WaitForSecondsRealtime(ShowBehavior.Animation.TotalDuration);
        ...
        private IEnumerator HideEnumerator(bool instantAction)
        {
            ...
            if (!HideBehavior.Animation.Move.Enabled) Container.ResetPosition();
            ...
            if (!HideBehavior.Animation.Rotate.Enabled) Container.ResetRotation();
            ...
            if (!HideBehavior.Animation.Scale.Enabled) Container.ResetScale();
            ...
            if (!HideBehavior.Animation.Fade.Enabled) Container.ResetAlpha();
...
//                    yield return new WaitForSecondsRealtime(HideBehavior.Animation.TotalDuration + UIViewSettings.DISABLE_WHEN_HIDDEN_TIME_BUFFER); //wait for seconds realtime (ignore Unity's Time.Timescale)
        ...
        private IEnumerator ExecuteShowSelectDeselectButtonEnumerator()
        {
            ...
            m_previousSelectedButton = EventSystem.current.currentSelectedGameObject; //save the currently selected button (so that the selection can be restored when the popup is hidden)
        ...
        private IEnumerator ExecuteHideDeselectButtonEnumerator()
        {
            ...
            EventSystem.current.SetSelectedGameObject(m_previousSelectedButton); //select the previously selected button (before the popup was shown)
        }
