...
namespace Doozy.Engine.UI
{
    ...
    public class UIDrawer : UIComponentBase<UIDrawer>, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        private void Update()
        {
            ...
            if (EventSystem.current.currentSelectedGameObject != null) //if the touch is over an interactable UI component -> return
                return;
        ...
        /// <summary> Disables gesture detection for this UIDrawer </summary>
        public void DisableGestureDetection() { DetectGestures = false; }

        /// <summary> Enables gesture detection for this UIDrawer </summary>
        public void EnableGestureDetection() { DetectGestures = true; }

        /// <summary> Sends an UIDrawerMessage notifying the system that an UIDrawerBehavior has been triggered </summary>
        ...
        /// <summary> Toggles the drawer's opened/closed state. If it's open it will close and vice versa </summary>
        ...
        /// <summary> Toggles gesture detection for this UIDrawer </summary>
        public void ToggleGestureDetection() { DetectGestures = !DetectGestures; }

        /// <summary> Updates the UIDrawerArrow Arrow by copying the UIDrawerContainer Container RectTransform properties to it </summary>
        public void UpdateArrowContainer() { Arrow.Container.Copy(Container.RectTransform); }

        /// <summary> Updates the UIDrawerContainer Container to the set settings. This method is mostly used by the editor button to help setup and design the container </summary>
        ...
        /// <summary> Updates the size of the UIDrawerContainer Container </summary>
        ...
        /// <summary> Updates the size of the UIDrawerContainer Container to FixedSize, with the given percentageOfScreen and minimumSize </summary>
        ...
        /// <summary> Updates the size of the UIDrawerContainer Container to PercentageOfScreen, with the given percentageOfScreen and minimumSize </summary>
        ...
        /// <summary> Updates the drawer's close direction </summary>
        ...
        /// <summary> Closes the UIDrawer, with the given drawer name, that exists in the UIDrawer Database </summary>
        ...
        /// <summary> Returns a reference to the first UIDrawer, wih the given drawer name, found in the UIDrawer Database. Returns null if an UIDrawer is not found </summary>
        /// <param name="drawerName"> Drawer name to search for </param>
        ...
        /// <summary> Opens the UIDrawer, with the given drawer name, that exists in the UIDrawer Database </summary>
        /// <param name="drawerName"> Drawer name to search for </param>
        /// <param name="debug"> Enable relevant debug messages to be printed to the console </param>
        ...
        /// <summary> Toggles the open/close state of an UIDrawer, with the given drawer name, that exists in the UIDrawer Database. If the drawer is opened it will close and vice versa </summary>
        /// <param name="drawerName"> Drawer name to search for </param>
        /// <param name="debug"> Enable relevant debug messages to be printed to the console </param>
