public class GraphQL
{
    ...
    {
        return "{\"query\": \"query GetGroundTypes{getGroundTypes{name, id}}\"}";
    }
    ...
    {
        return "{\"query\": \"query GetPlant($id: ID!) {getPlant(id: $id){type{name}, id, name, colors{name}, phRangeLow, phRangeHigh, thumbnail, rusticity, sunNeed, waterNeed, description, model, tips}}\", \"variables\": {\"id\": \"" + plantId + "\"}}";
    }
