...
public class GraphQL
{
    ...
    {
        return "{\"query\": \"query GetPlant($id: ID!) {getPlant(id: $id){type{name}, name, colors{name}, phRangeLow, phRangeHigh, thumbnail, rusticity, sunNeed, waterNeed}}\", \"variables\": {\"id\": \"" + plantId + "\"}}";
    }
