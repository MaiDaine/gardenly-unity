public class GraphQL
{
    ...
    {
        return "{\"query\": \"query GetPlant($id: ID!) {getPlant(id: $id){type{name}, id, name, colors{name}, phRangeLow, phRangeHigh, thumbnail, rusticity, sunNeed, waterNeed, description, model}}\", \"variables\": {\"id\": \"" + plantId + "\"}}";
    }
